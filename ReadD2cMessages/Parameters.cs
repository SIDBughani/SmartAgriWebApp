...
namespace ReadD2cMessages
{
    ...
    internal class Parameters
    {
        ...
        {
            return EventHubConnectionString ?? $"Endpoint=sb://ihsuprodlnres003dednamespace.servicebus.windows.net/;SharedAccessKeyName=iothubowner;SharedAccessKey=olvkgaPrVKFRTVP51xCfn+aGDx7ExqSfkZ21rssemhU=;EntityPath=iothub-ehub-smartagric-24926577-6e82d3d4bd";
        }
    }
}
